                    ...
                    <div class="table-wrapper">
                        <div class="table-title">
                            <div class="row">
                                ...
                                <div class="col-sm-6"> 
									{{-- <a href="{{ route('users.create') }}" class="btn btn-success" data-toggle="modal">
										<i class="material-icons">&#xE147;</i> <span>Add New User</span>
									</a> --}}
                                <a href="{{ route('users.create') }}" class="btn btn-outline-primary my-2 my-sm-0">add new user</a>
                            ...
                            <tbody>
                                @foreach ($users as $user)
                                    <tr>
                                        ...
                                        <td>
                                            <td>
                                            {{-- <form action="{{ route('user.edit', $user->id) }}" method="POST" style="display: inline;">
                                                @csrf
