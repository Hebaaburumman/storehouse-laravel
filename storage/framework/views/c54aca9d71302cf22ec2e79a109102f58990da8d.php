    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        ...
        <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
          ...
          <form class="form-inline my-2 my-lg-0">
            <a href="<?php echo e(route('users.list')); ?>" class="btn btn-outline-success my-2 my-sm-0">BACK</a>
          </form>
        </div>
      </nav>
...
</html><?php /**PATH /var/www/file/storehouse/resources/views/Users/edit.blade.php ENDPATH**/ ?>