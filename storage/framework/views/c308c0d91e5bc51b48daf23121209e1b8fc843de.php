  ...
  <nav class="navbar navbar-expand-lg navbar-light bg-light">
    ...
    <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
      ...
      <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
        ...
        <a href="<?php echo e(route('signup.show')); ?>" class="btn btn-outline-primary my-2 my-sm-0">Signup</a>
...
<?php /**PATH /var/www/file/storehouse/resources/views/Auth/login.blade.php ENDPATH**/ ?>